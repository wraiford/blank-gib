import thisHtml from './business.html';
import commonCss from '../web1-common.css';
import thisCss from './business.css';
...
const WEB1_COMPONENT_NAME: string = 'web1-join-up-component';
const WEB1_HTML_PATH: string = '/components/web1/join-up/join-up.html';
/**
...
const WEB1_SCRIPT_PATHS: string[] = [
    ...
    // '/components/web1/join-up/join-up.mjs',
];
const WEB1_CSS_PATHS: string[] = [
    '/styles.css',
    '/components/web1/web1-common.css',
    '/components/web1/join-up/join-up.css',
];

export const ComponentInfoWeb1_JoinUp = {
 ...
 */
export class Web1ComponentMeta_JoinUp
    extends Web1ComponentMetaBase {
    protected override lc: string = `[${Web1ComponentMeta_JoinUp.name}]`;
    ...
    routeRegExp?: RegExp = /apps\/web1\/gib\/join-up.html/;
    ...
    protected registerCustomElements(): void {
        customElements.define(this.componentName, Web1ComponentInstance_JoinUp);
    }

}

export class Web1ComponentInstance_JoinUp
    extends Web1ComponentInstanceBase {
    protected override lc: string = `[${Web1ComponentInstance_JoinUp.name}]`;
